...
Wilcoxon-Mann-Whitney, $\alpha = 0,05$). Os resultados indicam que GraphQL foi significativamente mais rápido que REST (Wilcoxon-Mann-Whitney, $p < 0,001$) e apresentou payloads significativamente menores (t de Student, $p < 0,001$).

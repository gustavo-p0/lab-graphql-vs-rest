...
Wilcoxon-Mann-Whitney, $\alpha = 0,05$). Os resultados indicam que GraphQL não foi significativamente mais rápido que REST (teste t, $p > 0,05$), mas apresentou payloads significativamente menores (Wilcoxon-Mann-Whitney, $p < 0,001$).

...
repositório (nome, estrelas e forks), sorteado aleatoriamente entre 5
repositórios populares: \texttt{facebook/react}, \texttt{tensorflow/tensorflow},
\texttt{nodejs/node}, \texttt{ansible/ansible} e \texttt{microsoft/vscode}.
